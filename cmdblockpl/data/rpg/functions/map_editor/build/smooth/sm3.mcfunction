#clear stone
execute if block ~ ~-4 ~ air run fill ~-1 ~-5 ~-1 ~1 ~-5 ~1 air replace stone
execute if block ~ ~-3 ~ air run fill ~-1 ~-4 ~-1 ~1 ~-4 ~1 air replace stone
execute if block ~ ~-2 ~ air run fill ~-1 ~-3 ~-1 ~1 ~-3 ~1 air replace stone
execute if block ~ ~-1 ~ air run fill ~-1 ~-2 ~-1 ~1 ~-2 ~1 air replace stone
fill ~-1 ~-1 ~-1 ~1 ~-1 ~1 air replace stone
